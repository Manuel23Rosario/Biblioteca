...
<head>
    ...
    <title>Libreria Los Tainos|Libros Disponibles</title>
...
<body>
 ...
 <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
        ...
        <tr>
            ...
            <tr>
                <td class="Filas"><?php echo $row["titulo"];?></td>
                <td class="Filas"><?php echo $row["tipo"];?></td>
                <td class="Filas"><?php echo $row["precio"];?></td>
            </tr>
            <?php }?>
        </table>
